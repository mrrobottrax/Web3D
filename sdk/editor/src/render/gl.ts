import { ShaderBase, defaultShader, gl, initCanvas, initDefaultShaders, initLineBuffer, initProgramFromWeb, initializeGl, skinnedShader, uiShader } from "../../../../src/client/render/gl.js";
